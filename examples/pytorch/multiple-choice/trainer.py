...
class CountShape(Trainer):
    def __init__(self, *args, **kwargs):
        ...
        if kwargs["args"].dynamic_checkpoint:
            ...
            if hasattr(kwargs["model"], "bert"):
                cast_forward(kwargs["model"].bert.encoder, "0", self.dc_manager)
            else:
                cast_forward(kwargs["model"].roberta.encoder, "0", self.dc_manager)
    ...
    def training_step(self, model: nn.Module, inputs) -> torch.Tensor:
        ...
        # print(f"memory: {torch.cuda.max_memory_allocated() / (1024 ** 2):.2f} MB", flush=True)
    ...
    def train(self, *args, **kwargs):
        ...
        if self.args.dynamic_checkpoint:
            ...
            if hasattr(self.model, "bert"):
                ...
                recover_forward(self.model.roberta.encoder)
        return ret
